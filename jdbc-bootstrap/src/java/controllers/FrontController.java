...
public class FrontController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("layout", "/WEB-INF/layouts/main.jsp"); //khai bao layout/template cua web
        ...
        String controller = url.substring(0, url.lastIndexOf("/")); //->user
        String action = url.substring(url.lastIndexOf("/") + 1, url.lastIndexOf("."));//->login
